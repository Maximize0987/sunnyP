...
class CarInterface(CarInterfaceBase):
  ...
  def _get_params(ret, candidate, fingerprint, car_fw, experimental_long, docs):
    ...
    if candidate in ANGLE_CONTROL_CAR:
      ...
      ret.steerActuatorDelay = 0.125        #       ret.steerActuatorDelay = 0.12  # Default delay, Prius has larger delay
      ret.steerLimitTimer = 0.2       #   ret.steerLimitTimer = 0.4
    ...
    if candidate == CAR.TOYOTA_PRIUS:
      ...
      #ret.lateralTuning.pid.kpV = [0.44]
      #ret.lateralTuning.pid.kiV = [0.11]
      #ret.lateralTuning.pid.kf = 0.000097 # 0.00007818594
