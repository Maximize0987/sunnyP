...
GEARS_ALLOW_PAUSED_SILENT = [EventNameSP.silentReverseGear, EventNameSP.silentBrakeHold, EventNameSP.silentDoorOpen, 
                             EventNameSP.silentParkBrake]
GEARS_ALLOW_PAUSED = [EventName.reverseGear, EventName.brakeHold, EventName.doorOpen, 
                      EventName.parkBrake]
